...
[![GoDoc](http://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/DFWallet/xecutil/coinset)
...
```bash
$ go get -u github.com/DFWallet/xecutil/coinset
```
